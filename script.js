...
// =========================================================================
// GESTÃO DO CARRINHO DE COMPRAS E O RESTO DAS FUNÇÕES
// =========================================================================
...
async function trocarAba(aba) { 
    ...
    if (aba === 'chat') { const chatArea = document.getElementById('chat-messages'); setTimeout(() => chatArea.scrollTop = chatArea.scrollHeight, 100); } 
}
